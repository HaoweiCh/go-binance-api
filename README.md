...
```shell
go get github.com/HaoweiCh/go-binance-api
```
...
import (
    ...
    "github.com/HaoweiCh/go-binance-api/futures" // optional package
    "github.com/HaoweiCh/go-binance-api/delivery" // optional package
    "github.com/HaoweiCh/go-binance-api/options" // optional package
)
```
...
```go
import (
    "github.com/HaoweiCh/go-binance-api/delivery"
)
